...
int _glfwGetPhysicalDevicePresentationSupportX11(VkInstance instance_, VkPhysicalDevice device, uint32_t queuefamily);
VkResult _glfwCreateWindowSurfaceX11(VkInstance instance_, _GLFWwindow* window, const VkAllocationCallbacks* allocator, VkSurfaceKHR* surface);
