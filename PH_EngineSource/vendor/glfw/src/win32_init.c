...
{
    _glfw.win32.user32.instance_ = _glfwPlatformLoadModule("user32.dll");
    if (!_glfw.win32.user32.instance_)
    {
    ...
    _glfw.win32.user32.SetProcessDPIAware_ = (PFN_SetProcessDPIAware)
        _glfwPlatformGetModuleSymbol(_glfw.win32.user32.instance_, "SetProcessDPIAware");
    _glfw.win32.user32.ChangeWindowMessageFilterEx_ = (PFN_ChangeWindowMessageFilterEx)
        _glfwPlatformGetModuleSymbol(_glfw.win32.user32.instance_, "ChangeWindowMessageFilterEx");
    _glfw.win32.user32.EnableNonClientDpiScaling_ = (PFN_EnableNonClientDpiScaling)
        _glfwPlatformGetModuleSymbol(_glfw.win32.user32.instance_, "EnableNonClientDpiScaling");
    _glfw.win32.user32.SetProcessDpiAwarenessContext_ = (PFN_SetProcessDpiAwarenessContext)
        _glfwPlatformGetModuleSymbol(_glfw.win32.user32.instance_, "SetProcessDpiAwarenessContext");
    _glfw.win32.user32.GetDpiForWindow_ = (PFN_GetDpiForWindow)
        _glfwPlatformGetModuleSymbol(_glfw.win32.user32.instance_, "GetDpiForWindow");
    _glfw.win32.user32.AdjustWindowRectExForDpi_ = (PFN_AdjustWindowRectExForDpi)
        _glfwPlatformGetModuleSymbol(_glfw.win32.user32.instance_, "AdjustWindowRectExForDpi");

    _glfw.win32.dinput8.instance_ = _glfwPlatformLoadModule("dinput8.dll");
    if (_glfw.win32.dinput8.instance_)
    {
        _glfw.win32.dinput8.Create = (PFN_DirectInput8Create)
            _glfwPlatformGetModuleSymbol(_glfw.win32.dinput8.instance_, "DirectInput8Create");
    }

    {
        ...
        for (i = 0;  names[i];  i++)
        {
            _glfw.win32.xinput.instance_ = _glfwPlatformLoadModule(names[i]);
            if (_glfw.win32.xinput.instance_)
            {
                _glfw.win32.xinput.GetCapabilities = (PFN_XInputGetCapabilities)
                    _glfwPlatformGetModuleSymbol(_glfw.win32.xinput.instance_, "XInputGetCapabilities");
                _glfw.win32.xinput.GetState = (PFN_XInputGetState)
                    _glfwPlatformGetModuleSymbol(_glfw.win32.xinput.instance_, "XInputGetState");
    ...
    _glfw.win32.dwmapi.instance_ = _glfwPlatformLoadModule("dwmapi.dll");
    if (_glfw.win32.dwmapi.instance_)
    {
        _glfw.win32.dwmapi.IsCompositionEnabled = (PFN_DwmIsCompositionEnabled)
            _glfwPlatformGetModuleSymbol(_glfw.win32.dwmapi.instance_, "DwmIsCompositionEnabled");
        _glfw.win32.dwmapi.Flush = (PFN_DwmFlush)
            _glfwPlatformGetModuleSymbol(_glfw.win32.dwmapi.instance_, "DwmFlush");
        _glfw.win32.dwmapi.EnableBlurBehindWindow = (PFN_DwmEnableBlurBehindWindow)
            _glfwPlatformGetModuleSymbol(_glfw.win32.dwmapi.instance_, "DwmEnableBlurBehindWindow");
        _glfw.win32.dwmapi.GetColorizationColor = (PFN_DwmGetColorizationColor)
            _glfwPlatformGetModuleSymbol(_glfw.win32.dwmapi.instance_, "DwmGetColorizationColor");
    }

    _glfw.win32.shcore.instance_ = _glfwPlatformLoadModule("shcore.dll");
    if (_glfw.win32.shcore.instance_)
    {
        _glfw.win32.shcore.SetProcessDpiAwareness_ = (PFN_SetProcessDpiAwareness)
            _glfwPlatformGetModuleSymbol(_glfw.win32.shcore.instance_, "SetProcessDpiAwareness");
        _glfw.win32.shcore.GetDpiForMonitor_ = (PFN_GetDpiForMonitor)
            _glfwPlatformGetModuleSymbol(_glfw.win32.shcore.instance_, "GetDpiForMonitor");
    }

    _glfw.win32.ntdll.instance_ = _glfwPlatformLoadModule("ntdll.dll");
    if (_glfw.win32.ntdll.instance_)
    {
        _glfw.win32.ntdll.RtlVerifyVersionInfo_ = (PFN_RtlVerifyVersionInfo)
            _glfwPlatformGetModuleSymbol(_glfw.win32.ntdll.instance_, "RtlVerifyVersionInfo");
    }
...
{
    if (_glfw.win32.xinput.instance_)
        _glfwPlatformFreeModule(_glfw.win32.xinput.instance_);

    if (_glfw.win32.dinput8.instance_)
        _glfwPlatformFreeModule(_glfw.win32.dinput8.instance_);

    if (_glfw.win32.user32.instance_)
        _glfwPlatformFreeModule(_glfw.win32.user32.instance_);

    if (_glfw.win32.dwmapi.instance_)
        _glfwPlatformFreeModule(_glfw.win32.dwmapi.instance_);

    if (_glfw.win32.shcore.instance_)
        _glfwPlatformFreeModule(_glfw.win32.shcore.instance_);

    if (_glfw.win32.ntdll.instance_)
        _glfwPlatformFreeModule(_glfw.win32.ntdll.instance_);
}
