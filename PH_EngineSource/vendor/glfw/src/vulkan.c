...
GLFWAPI GLFWvkproc glfwGetInstanceProcAddress(VkInstance instance_,
                                              const char* procname)
{
    GLFWvkproc proc;
    ...
    proc = (GLFWvkproc) vkGetInstanceProcAddr(instance_, procname);
    if (!proc)
    {
        if (_glfw.vk.handle)
...
GLFWAPI int glfwGetPhysicalDevicePresentationSupport(VkInstance instance_,
                                                     ...
                                                     uint32_t queuefamily)
{
    ...
    return _glfw.platform.getPhysicalDevicePresentationSupport(instance_,
                                                               device,
                                                               queuefamily);
}

GLFWAPI VkResult glfwCreateWindowSurface(VkInstance instance_,
                                         GLFWwindow* handle,
                                         ...
                                         VkSurfaceKHR* surface)
{
    ...
    *surface = VK_NULL_HANDLE;
    ...
    return _glfw.platform.createWindowSurface(instance_, window, allocator, surface);
}
