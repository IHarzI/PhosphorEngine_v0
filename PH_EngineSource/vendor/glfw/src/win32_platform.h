...
int _glfwGetPhysicalDevicePresentationSupportWin32(VkInstance instance_, VkPhysicalDevice device, uint32_t queuefamily);
VkResult _glfwCreateWindowSurfaceWin32(VkInstance instance_, _GLFWwindow* window, const VkAllocationCallbacks* allocator, VkSurfaceKHR* surface);
