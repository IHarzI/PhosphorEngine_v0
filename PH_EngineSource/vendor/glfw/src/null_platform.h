...
int _glfwGetPhysicalDevicePresentationSupportNull(VkInstance instance_, VkPhysicalDevice device, uint32_t queuefamily);
VkResult _glfwCreateWindowSurfaceNull(VkInstance instance_, _GLFWwindow* window, const VkAllocationCallbacks* allocator, VkSurfaceKHR* surface);
