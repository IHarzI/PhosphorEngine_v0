...
static GLFWglproc getProcAddressWGL(const char* procname)
{
    ...
    return (GLFWglproc) _glfwPlatformGetModuleSymbol(_glfw.wgl.instance_, procname);
}
...
GLFWbool _glfwInitWGL(void)
{
    ...
    if (_glfw.wgl.instance_)
        return GLFW_TRUE;

    _glfw.wgl.instance_ = _glfwPlatformLoadModule("opengl32.dll");
    if (!_glfw.wgl.instance_)
    {
        _glfwInputErrorWin32(GLFW_PLATFORM_ERROR,
    ...
    _glfw.wgl.CreateContext = (PFN_wglCreateContext)
        _glfwPlatformGetModuleSymbol(_glfw.wgl.instance_, "wglCreateContext");
    _glfw.wgl.DeleteContext = (PFN_wglDeleteContext)
        _glfwPlatformGetModuleSymbol(_glfw.wgl.instance_, "wglDeleteContext");
    _glfw.wgl.GetProcAddress = (PFN_wglGetProcAddress)
        _glfwPlatformGetModuleSymbol(_glfw.wgl.instance_, "wglGetProcAddress");
    _glfw.wgl.GetCurrentDC = (PFN_wglGetCurrentDC)
        _glfwPlatformGetModuleSymbol(_glfw.wgl.instance_, "wglGetCurrentDC");
    _glfw.wgl.GetCurrentContext = (PFN_wglGetCurrentContext)
        _glfwPlatformGetModuleSymbol(_glfw.wgl.instance_, "wglGetCurrentContext");
    _glfw.wgl.MakeCurrent = (PFN_wglMakeCurrent)
        _glfwPlatformGetModuleSymbol(_glfw.wgl.instance_, "wglMakeCurrent");
    _glfw.wgl.ShareLists = (PFN_wglShareLists)
        _glfwPlatformGetModuleSymbol(_glfw.wgl.instance_, "wglShareLists");
...
{
    if (_glfw.wgl.instance_)
        _glfwPlatformFreeModule(_glfw.wgl.instance_);
}
