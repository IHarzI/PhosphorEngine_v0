...
int _glfwGetPhysicalDevicePresentationSupportCocoa(VkInstance instance_, VkPhysicalDevice device, uint32_t queuefamily);
VkResult _glfwCreateWindowSurfaceCocoa(VkInstance instance_, _GLFWwindow* window, const VkAllocationCallbacks* allocator, VkSurfaceKHR* surface);
