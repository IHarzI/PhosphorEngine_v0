...
int _glfwGetPhysicalDevicePresentationSupportWayland(VkInstance instance_, VkPhysicalDevice device, uint32_t queuefamily);
VkResult _glfwCreateWindowSurfaceWayland(VkInstance instance_, _GLFWwindow* window, const VkAllocationCallbacks* allocator, VkSurfaceKHR* surface);
