...
int _glfwGetPhysicalDevicePresentationSupportWin32(VkInstance instance_,
                                                   ...
                                                   uint32_t queuefamily)
{
    PFN_vkGetPhysicalDeviceWin32PresentationSupportKHR
        ...
        (PFN_vkGetPhysicalDeviceWin32PresentationSupportKHR)
        vkGetInstanceProcAddr(instance_, "vkGetPhysicalDeviceWin32PresentationSupportKHR");
...
VkResult _glfwCreateWindowSurfaceWin32(VkInstance instance_,
                                       _GLFWwindow* window,
                                       ...
                                       VkSurfaceKHR* surface)
{
    ...
    err = vkCreateWin32SurfaceKHR(instance_, &sci, allocator, surface);
    if (err)
    {
        _glfwInputError(GLFW_PLATFORM_ERROR,
